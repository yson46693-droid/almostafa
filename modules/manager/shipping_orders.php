                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li><a class="dropdown-item" href="javascript:void(0)" onclick="event.preventDefault(); showShippingCompanyStatement(<?php echo (int)$company['id']; ?>, <?php echo json_encode($company['name'], JSON_UNESCAPED_UNICODE); ?>);"><i class="bi bi-journal-text me-2"></i>كشف حساب</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0)" onclick="event.preventDefault(); showCompanyPaperInvoicesByIdName(<?php echo (int)$company['id']; ?>, <?php echo json_encode($company['name'], JSON_UNESCAPED_UNICODE); ?>);"><i class="bi bi-receipt-cutoff me-2"></i>فواتير ورقية</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0)" onclick="event.preventDefault(); showEditBalanceByIdName(<?php echo (int)$company['id']; ?>, <?php echo json_encode($company['name'], JSON_UNESCAPED_UNICODE); ?>, <?php echo $companyBalance; ?>);"><i class="bi bi-pencil me-2"></i>تعديل الديون</a></li>
                                            <li><a class="dropdown-item <?php echo $companyBalance <= 0 ? 'disabled' : ''; ?>" href="javascript:void(0)" onclick="event.preventDefault(); if (!this.classList.contains('disabled')) showCollectByIdName(<?php echo (int)$company['id']; ?>, <?php echo json_encode($company['name'], JSON_UNESCAPED_UNICODE); ?>, <?php echo $companyBalance; ?>, <?php echo json_encode($balanceFormatted, JSON_UNESCAPED_UNICODE); ?>);"><i class="bi bi-cash-coin me-2"></i>تحصيل</a></li>
                                            <li><hr class="dropdown-divider"></li>
                                            <li><a class="dropdown-item <?php echo $companyBalance <= 0 ? 'disabled' : ''; ?>" href="javascript:void(0)" onclick="event.preventDefault(); if (!this.classList.contains('disabled')) showDeductFromShippingCompany(<?php echo (int)$company['id']; ?>, <?php echo json_encode($company['name'], JSON_UNESCAPED_UNICODE); ?>, <?php echo $companyBalance; ?>);"><i class="bi bi-dash-circle me-2"></i>خصم</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>

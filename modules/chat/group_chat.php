...
<!-- ضمان تحميل Bootstrap CSS في صفحة الشات -->
<script>
(function() {
    'use strict';
    
    // التحقق من تحميل Bootstrap CSS
    function checkBootstrapCSS() {
        // التحقق من وجود Bootstrap CSS
            ...
            try {
                ...
                if (href.indexOf('bootstrap') !== -1 && href.indexOf('.css') !== -1) {
                    ...
                    try {
                        ...
                        // قد يكون هناك CORS error، لكن CSS محمل
                        bootstrapLoaded = true;
                        break;
                    }
                }
        ...
        // إذا لم يتم تحميل Bootstrap CSS، قم بتحميله
        if (!bootstrapLoaded) {
        ...
        // التحقق من تحميل Bootstrap Icons
        ...
        if (!iconsLoaded) {
            ...
            iconsLink.crossOrigin = 'anonymous';
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', function() {
            setTimeout(checkBootstrapCSS, 100);
        });
    } else {
        setTimeout(checkBootstrapCSS, 100);
    }
    
    // التحقق مرة أخرى بعد تحميل جميع الموارد
    window.addEventListener('load', function() {
        setTimeout(checkBootstrapCSS, 500);
    });
})();
</script>
